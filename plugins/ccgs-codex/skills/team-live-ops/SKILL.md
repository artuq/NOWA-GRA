...
Invoke this workflow as `$team-live-ops` followed by any arguments in the user's prompt.
...
delegated to sub-agents spawned through Codex subagent delegation. Each sub-agent enforces the
