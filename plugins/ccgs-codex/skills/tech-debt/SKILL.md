...
Invoke this workflow as `$tech-debt` followed by any arguments in the user's prompt.
...
Then use `Codex user-input mechanism` to collect the **category**:
...
Then use `Codex user-input mechanism` to collect the **estimated fix effort**:
