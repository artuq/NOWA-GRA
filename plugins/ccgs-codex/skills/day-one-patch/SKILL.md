...
Invoke this workflow as `$day-one-patch` followed by any arguments in the user's prompt.
...
Use `Codex user-input mechanism` to confirm proceeding or reduce scope.
