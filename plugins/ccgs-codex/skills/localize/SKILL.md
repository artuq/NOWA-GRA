...
Invoke this workflow as `$localize` followed by any arguments in the user's prompt.
...
Recommended role: `localization-lead` from `.codex/agents/localization-lead.toml`. Keep the primary thread responsible for user-facing choices.
