...
Invoke this workflow as `$scope-check` followed by any arguments in the user's prompt.
...
**Argument:** `invocation argument 1 from the user text after $scope-check` — feature name, sprint number, or milestone name.
