...
Invoke this workflow as `$project-stage-detect` followed by any arguments in the user's prompt.
...
Use template: `plugins/ccgs-codex/assets/templates/project-stage-report.md`
