...
Invoke this workflow as `$vertical-slice` followed by any arguments in the user's prompt.
...
Read `plugins/ccgs-codex/assets/templates/vertical-slice-report.md` to get the report structure.
