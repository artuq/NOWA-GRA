...
Invoke this workflow as `$quick-design` followed by any arguments in the user's prompt.
...
Present the inferred classification using `Codex user-input mechanism`:
...
Present the draft to the user in full. Then use `Codex user-input mechanism`:
