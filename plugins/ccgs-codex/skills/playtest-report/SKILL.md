...
Invoke this workflow as `$playtest-report` followed by any arguments in the user's prompt.
...
After categorising findings, spawn `creative-director` through Codex subagent delegation using gate **CD-PLAYTEST** (`plugins/ccgs-codex/references/director-gates.md`).
