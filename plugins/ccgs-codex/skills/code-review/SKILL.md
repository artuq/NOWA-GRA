...
Invoke this workflow as `$code-review` followed by any arguments in the user's prompt.
...
Legacy tool profile (guidance only): `Read, Glob, Grep, Bash, subagent delegation, user-input`.
