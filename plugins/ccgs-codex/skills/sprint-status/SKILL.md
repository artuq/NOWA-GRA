...
Invoke this workflow as `$sprint-status` followed by any arguments in the user's prompt.
...
**Argument:** `invocation argument 1 from the user text after $sprint-status` (blank = use current sprint)
